...
public enum ProvincesEnumExercise {
    ...
    ProvincesEnumExercise(final String label, final int population, final int municipalities, final PlanningRegion planningRegionFirst, final PlanningRegion planningRegionSecond) {
        this.label = label;
        this.population = population;
        this.municipalities = municipalities;
        this.planningRegionFirst = planningRegionFirst;
    ...
    public static ProvincesEnumExercise fromStringLabel(final String label) {
    ...
    public static void main(final String[] args) {
        System.out.println(ProvincesEnumExercise.fromStringLabel("plovdiv"));
        System.out.println(ProvincesEnumExercise.fromStringLabel("varna"));
        System.out.println(ProvincesEnumExercise.fromStringLabel("burgas"));
        System.out.println(ProvincesEnumExercise.fromStringLabel("haskovo"));
    }
}
